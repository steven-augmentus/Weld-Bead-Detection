...
def run(input_pcd):
    bead_pcd, plane1_pcd, plane2_pcd = segment_corner_weld(input_pcd, eps=0.01, min_points=50, normal_consistency_angle_deg=30.0)
    ...
    centerline_pcd = contract_to_centerline(cleaned_bead_pcd, num_iterations=20000, contraction_factor=0.01)
...
if __name__ == "__main__":
    ...
    bead_pcd, plane1_pcd, plane2_pcd = segment_corner_weld(pcd, eps=0.01, min_points=50, normal_consistency_angle_deg=30.0)
